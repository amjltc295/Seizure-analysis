...
if __name__ == "__main__":
    ...
    ref = os.path.join(current_path, 'seizure-data/seizure03/160816sei03_ctrl.mat')
    filename = os.path.join(current_path, 'seizure-data/seizure03/160816sei03_ptz_behavior.mat')
    """
    ref = os.path.join(current_path, 'seizure-data/seizure03/160805sei03_ctrl.mat')
    filename = os.path.join(current_path, 'seizure-data/seizure03/160805sei03_ptz_behavior.mat')
    """
    """
