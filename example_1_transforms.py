...
class STFT:
    ...
    def get_name(self):
        return 'stft-%d-%d' % (self.start, self.end)
...
class FreqCorrelation_whole:
    """
    Frequncy correlation with whole matrix
    """
    def __init__(self, start, end, scale_option, with_fft=False, with_corr=True, with_eigen=True):
        self.start = start
        self.end = end
...
class TimeCorrelation_whole:
    """
    TimeCorrelation with whole matrix.
    """
    def __init__(self, max_hz, scale_option, with_corr=True, with_eigen=True):
        self.max_hz = max_hz
        self.scale_option = scale_option
